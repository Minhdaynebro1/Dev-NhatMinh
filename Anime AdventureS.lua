...
warn("[WORLD SJW HUB] Loading Ui")
wait()

--Loading UI Library
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/NhatMinhVNQ/w-hub/refs/heads/main/Library.lua"))()
local ThemeManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/TrilhaX/tempestHubUI/refs/heads/main/addons/ThemeManager.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/TrilhaX/tempestHubUI/refs/heads/main/addons/SaveManager.lua"))()
Library:Notify("https://discord.gg/zedNpbzxpA", 5)

--Configuring UI Library
local Window = Library:CreateWindow({
	Title = "World Sjw Hub | Version: 0.0.3",
	Center = true,
	AutoShow = true,
	TabPadding = 8,
	MenuFadeTime = 0.2,
...
warn("[WORLD SJW HUB] Loading Function")
wait()
warn("[WORLD SJW HUB] Loading Toggles")
wait()
warn("[WORLD SJW HUB] Last Checking")
wait()
                ...
                embeds = {
                    {
                        ...
                        footer = {
                            text = "https://discord.gg/zedNpbzxpA - World Sjw Hub"
                        },
                        timestamp = os.date("!%Y-%m-%dT%H:%M:%SZ"),
                        thumbnail = {
                            url = "https://media.discordapp.net/attachments/1262021207952457739/1333779119644610591/WSJ_7_-_2025-01-28T182219.364.png"
                        }
                    }
                },
                attachments = {}
...
local function UpdateWatermark()
	...
	Library:SetWatermark(
		("World Sjw Hub | %s fps | %s ms | %s"):format(
			math.floor(FPS),
...
--Save Settings
ThemeManager:SetFolder("World Sjw Hub")
SaveManager:SetFolder("World Sjw Hub/_AA_")
